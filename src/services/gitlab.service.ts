import { MergeRequest } from "./MergeRequest.interface";

export async function getMrInfo(jiraTicket: string, token: string, baseUrl: string, projectIds: string[]): Promise<MergeRequest[]> {
